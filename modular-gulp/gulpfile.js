...
/* -------------------------------
 Available Tasks
 ------------------------------- */
// gulp                     -- Lints js & sass, watches sass, starts up the PL server.
...
// Directories
var sassFiles       = 'pattern-lab/source/sass/**/*.scss'; // replace this with the path to your sass directory.
var patternLabFiles = 'pattern-lab/source/_patterns/**/*.scss'; // Replace with top level PL directory if any
var cssDir          = 'pattern-lab/source/css'; // Replace with path to CSS dir
var jsDir           = 'js/*.js';
...
require('./gulp-tasks/pattern-lab')(gulp, options, plugins);
